...
import 'package:here_sdk/src/sdk/routing/vehicle_restriction_max_weight.dart';
...
class ViolatedRestrictionDetails {
  ...
  @Deprecated("Will be remove in v4.24.0. Use [ViolatedRestrictionDetails.maxWeight] instead.")
...
final _sdkRoutingViolatedrestrictionDetailsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>)
...
final _sdkRoutingViolatedrestrictionDetailsGetFieldmaxWeight = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_ViolatedRestriction_Details_get_field_maxWeight'));
...
Pointer<Void> sdkRoutingViolatedrestrictionDetailsToFfi(ViolatedRestrictionDetails value) {
  ...
  sdkRoutingVehiclerestrictionmaxweightReleaseFfiHandleNullable(_maxWeightHandle);
  return _result;
}
...
ViolatedRestrictionDetails sdkRoutingViolatedrestrictionDetailsFromFfi(Pointer<Void> handle) {
  ...
  final _maxWeightHandle = _sdkRoutingViolatedrestrictionDetailsGetFieldmaxWeight(handle);
  try {
    return ViolatedRestrictionDetails._(
      ...
      sdkRoutingVehiclerestrictionmaxweightFromFfiNullable(_maxWeightHandle)
    );
  } finally {
    intReleaseFfiHandleNullable(_maxGrossWeightInKilogramsHandle);
    intReleaseFfiHandleNullable(_maxWeightPerAxleInKilogramsHandle);
