...
class RouteOptions {
  ...
  @Deprecated("Will be removed in v4.23.0. Please use [RouteOptions.occupantsNumber] in corresponding transport mode options instead, like [CarOptions.occupantsNumber].")
  int occupantsNumber;
