...
abstract class Maneuver implements Finalizable {
  ...
  /// The road type of the current road. The value is `null` when no data is available.
  ...
  /// The road type of the next road. The value is `null` when no data is available.
  ...
  /// [RouteTextOptions].
  /// **Note for _Navigate Edition_:** This text is meant to be displayed in a preview context, whereas real-time `EventTextListener` texts are meant to be used
  ...
  /// The index of a section to which the maneuver belongs to.
