...
class BatterySpecifications {
  ...
  /// Defaults to 0.
  /// **Note:**
  /// For a user-planned [ChargingStop], this parameter is also required.
  ...
  bool operator ==(Object other) {
    ...
    return totalCapacityInKilowattHours == _other.totalCapacityInKilowattHours &&
        ...
        maxPowerAtLowVoltageInKilowatts == _other.maxPowerAtLowVoltageInKilowatts;
  }
...
final _sdkRoutingBatteryspecificationsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Double, Double, Double, Pointer<Void>, Pointer<Void>, Double, Pointer<Void>, Double, Pointer<Void>, Pointer<Void>, Uint64, Pointer<Void>),
    Pointer<Void> Function(double, double, double, Pointer<Void>, Pointer<Void>, double, Pointer<Void>, double, Pointer<Void>, Pointer<Void>, int, Pointer<Void>)
...
final _sdkRoutingBatteryspecificationsGetFieldmaxPowerAtLowVoltageInKilowatts = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_BatterySpecifications_get_field_maxPowerAtLowVoltageInKilowatts'));
...
Pointer<Void> sdkRoutingBatteryspecificationsToFfi(BatterySpecifications value) {
  ...
  doubleReleaseFfiHandleNullable(_maxPowerAtLowVoltageInKilowattsHandle);
  return _result;
}
...
BatterySpecifications sdkRoutingBatteryspecificationsFromFfi(Pointer<Void> handle) {
  ...
  final _maxPowerAtLowVoltageInKilowattsHandle = _sdkRoutingBatteryspecificationsGetFieldmaxPowerAtLowVoltageInKilowatts(handle);
  try {
    return BatterySpecifications(
      ...
      doubleFromFfiNullable(_maxPowerAtLowVoltageInKilowattsHandle)
    );
  } finally {
