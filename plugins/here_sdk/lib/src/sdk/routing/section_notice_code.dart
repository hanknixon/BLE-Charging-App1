...
int sdkRoutingSectionnoticecodeToFfi(SectionNoticeCode value) {
  ...
  case SectionNoticeCode.potentialZoneRestriction:
    return 34;
  case SectionNoticeCode.violatedMinChargeAtFirstCs:
    return 35;
  case SectionNoticeCode.violatedMinChargeAtCs:
    return 36;
  case SectionNoticeCode.violatedMinChargeAtDestination:
    return 37;
  case SectionNoticeCode.noThroughRestriction:
    return 38;
  }
}
...
SectionNoticeCode sdkRoutingSectionnoticecodeFromFfi(int handle) {
  ...
  case 35:
    return SectionNoticeCode.violatedMinChargeAtFirstCs;
  case 36:
    return SectionNoticeCode.violatedMinChargeAtCs;
  case 37:
    return SectionNoticeCode.violatedMinChargeAtDestination;
  case 38:
    return SectionNoticeCode.noThroughRestriction;
  default:
