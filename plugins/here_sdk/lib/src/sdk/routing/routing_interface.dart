...
/// routing engines.
abstract class RoutingInterface implements Finalizable {
  /// Provides the abstract class for the online and offline
  /// routing engines.
...
class RoutingInterface$Lambdas implements RoutingInterface {
  ...
  RoutingInterface$Lambdas(
    this.calculateRouteWithRoutingOptionsLambda,
  ...
  @override
  TaskHandle calculateRouteWithRoutingOptions(List<Waypoint> waypoints, RoutingOptions options, CalculateRouteCallback callback) =>
    calculateRouteWithRoutingOptionsLambda(waypoints, options, callback);
  @override
  TaskHandle calculateCarRoute(List<Waypoint> waypoints, CarOptions carOptions, CalculateRouteCallback callback) =>
...
class RoutingInterface$Impl extends __lib.NativeBase implements RoutingInterface {
  ...
  @override
  TaskHandle calculateRouteWithRoutingOptions(List<Waypoint> waypoints, RoutingOptions options, CalculateRouteCallback callback) {
    final _calculateRouteWithRoutingOptionsFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_routing_RoutingInterface_calculateRoute__ListOf_sdk_routing_Waypoint_RoutingOptions_CalculateRouteCallback'));
...
int _sdkRoutingRoutinginterfacecalculateRouteWithRoutingOptionsStatic(Object _obj, Pointer<Void> waypoints, Pointer<Void> options, Pointer<Void> callback, Pointer<Pointer<Void>> _result) {
  TaskHandle? _resultObject;
  try {
    _resultObject = (_obj as RoutingInterface).calculateRouteWithRoutingOptions(heresdkRoutingCommonBindingslistofSdkRoutingWaypointFromFfi(waypoints), sdkRoutingRoutingoptionsFromFfi(options), sdkRoutingCalculateroutecallbackFromFfi(callback));
    ...
    sdkRoutingRoutingoptionsReleaseFfiHandle(options);
...
Pointer<Void> sdkRoutingRoutinginterfaceToFfi(RoutingInterface value) {
  ...
  final result = _sdkRoutingRoutinginterfaceCreateProxy(
    ...
    value,
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Pointer<Void>>)>(_sdkRoutingRoutinginterfacecalculateRouteWithRoutingOptionsStatic, __lib.unknownError),
