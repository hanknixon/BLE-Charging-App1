...
abstract class SDKNativeEngine implements Finalizable {
  ...
  /// @nodoc
  static void initOptionalModules(SDKNativeEngine self) => $prototype.initOptionalModules(self);
  ...
  /// If a device has a different device ID within the same month, it is counted as a separate MAU.
  /// However, if the device ID changes across different months, it still contributes to the same overall MAU count.
  ///
  ...
  /// Sets offline mode for the HERE SDK. Defaults to false, which means the HERE SDK uses an online connection.
  ...
  /// **Note:** This is a beta release of this feature, so there could be a few bugs and unexpected behaviors.
  /// Related APIs may change for new releases without a deprecation process.
  /// Gets the current proxy settings. Defaults to (`null`), which indicates proxy is not enabled.
  ///
  /// **Note:** This is a beta release of this feature, so there could be a few bugs and unexpected behaviors.
  /// Related APIs may change for new releases without a deprecation process.
...
enum SDKNativeEnginePurgeMemoryStrategy {
    /// No content in the caches preserved.
    full
}

// SDKNativeEnginePurgeMemoryStrategy "private" section, not exported.

int sdkCoreEngineSdknativeenginePurgememorystrategyToFfi(SDKNativeEnginePurgeMemoryStrategy value) {
  switch (value) {
  case SDKNativeEnginePurgeMemoryStrategy.full:
    return 0;
  }
}

SDKNativeEnginePurgeMemoryStrategy sdkCoreEngineSdknativeenginePurgememorystrategyFromFfi(int handle) {
  switch (handle) {
  case 0:
    return SDKNativeEnginePurgeMemoryStrategy.full;
  default:
    throw StateError("Invalid numeric value $handle for SDKNativeEnginePurgeMemoryStrategy enum.");
  }
}

void sdkCoreEngineSdknativeenginePurgememorystrategyReleaseFfiHandle(int handle) {}

final _sdkCoreEngineSdknativeenginePurgememorystrategyCreateHandleNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32),
    Pointer<Void> Function(int)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_PurgeMemoryStrategy_create_handle_nullable'));
final _sdkCoreEngineSdknativeenginePurgememorystrategyReleaseHandleNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_PurgeMemoryStrategy_release_handle_nullable'));
final _sdkCoreEngineSdknativeenginePurgememorystrategyGetValueNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_PurgeMemoryStrategy_get_value_nullable'));

Pointer<Void> sdkCoreEngineSdknativeenginePurgememorystrategyToFfiNullable(SDKNativeEnginePurgeMemoryStrategy? value) {
  if (value == null) return Pointer<Void>.fromAddress(0);
  final _handle = sdkCoreEngineSdknativeenginePurgememorystrategyToFfi(value);
  final result = _sdkCoreEngineSdknativeenginePurgememorystrategyCreateHandleNullable(_handle);
  sdkCoreEngineSdknativeenginePurgememorystrategyReleaseFfiHandle(_handle);
  return result;
}

SDKNativeEnginePurgeMemoryStrategy? sdkCoreEngineSdknativeenginePurgememorystrategyFromFfiNullable(Pointer<Void> handle) {
  if (handle.address == 0) return null;
  final _handle = _sdkCoreEngineSdknativeenginePurgememorystrategyGetValueNullable(handle);
  final result = sdkCoreEngineSdknativeenginePurgememorystrategyFromFfi(_handle);
  sdkCoreEngineSdknativeenginePurgememorystrategyReleaseFfiHandle(_handle);
  return result;
}

void sdkCoreEngineSdknativeenginePurgememorystrategyReleaseFfiHandleNullable(Pointer<Void> handle) =>
  _sdkCoreEngineSdknativeenginePurgememorystrategyReleaseHandleNullable(handle);

// End of SDKNativeEnginePurgeMemoryStrategy "private" section.
...
final _initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_initOptionalModules__SDKNativeEngine_return_release_handle'));
final _initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_initOptionalModules__SDKNativeEngine_return_get_error'));
final _initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_initOptionalModules__SDKNativeEngine_return_has_error'));
...
class SDKNativeEngine$Impl extends __lib.NativeBase implements SDKNativeEngine {
  ...
  void initOptionalModules(SDKNativeEngine self) {
    final _initOptionalModulesFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>)>('here_sdk_sdk_core_engine_SDKNativeEngine_initOptionalModules__SDKNativeEngine'));
    final _selfHandle = sdkCoreEngineSdknativeengineToFfi(self);
    final __callResultHandle = _initOptionalModulesFfi(__lib.LibraryContext.isolateId, _selfHandle);
    sdkCoreEngineSdknativeengineReleaseFfiHandle(_selfHandle);
    if (_initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnGetError(__callResultHandle);
        _initOptionalModulessdkCoreEngineSdknativeengineInitoptionalmodulesSdknativeengineReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
  ...
  @override
  void purgeMemoryCaches(SDKNativeEnginePurgeMemoryStrategy strategy) {
    final _purgeMemoryCachesFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Uint32), void Function(Pointer<Void>, int, int)>('here_sdk_sdk_core_engine_SDKNativeEngine_purgeMemoryCaches__PurgeMemoryStrategy'));
    final _strategyHandle = sdkCoreEngineSdknativeenginePurgememorystrategyToFfi(strategy);
    final _handle = this.handle;
    _purgeMemoryCachesFfi(_handle, __lib.LibraryContext.isolateId, _strategyHandle);
    sdkCoreEngineSdknativeenginePurgememorystrategyReleaseFfiHandle(_strategyHandle);
  ...
  void _getDeviceId__async(SDKNativeEnginegetDeviceId__resultLambda _resultLambda) {
    final __getDeviceId__asyncFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_core_engine_SDKNativeEngine_getDeviceId__get_device_id__resultLambda'));
    final __resultLambdaHandle = sdkCoreEngineSdknativeengineGetdeviceidresultlambdaToFfi(_resultLambda);
    final _handle = this.handle;
    __getDeviceId__asyncFfi(_handle, __lib.LibraryContext.isolateId, __resultLambdaHandle);
    sdkCoreEngineSdknativeengineGetdeviceidresultlambdaReleaseFfiHandle(__resultLambdaHandle);
...
class SDKNativeEnginedispose__resultLambda$Impl implements Finalizable {
...
class SDKNativeEnginemakeSharedInstance__resultLambda$Impl implements Finalizable {
  final Pointer<Void> handle;
...
class SDKNativeEnginemakeSharedInstance__errorLambda$Impl implements Finalizable {
  final Pointer<Void> handle;
...
typedef SDKNativeEnginegetDeviceId__resultLambda = void Function(String);

// SDKNativeEnginegetDeviceId__resultLambda "private" section, not exported.

final _sdkCoreEngineSdknativeengineGetdeviceidresultlambdaReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_GetDeviceIdResultlambda_release_handle'));
final _sdkCoreEngineSdknativeengineGetdeviceidresultlambdaCreateProxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint64, Int32, Handle, Pointer),
    Pointer<Void> Function(int, int, Object, Pointer)
  >('here_sdk_sdk_core_engine_SDKNativeEngine_GetDeviceIdResultlambda_create_proxy'));

class SDKNativeEnginegetDeviceId__resultLambda$Impl implements Finalizable {
  final Pointer<Void> handle;
  SDKNativeEnginegetDeviceId__resultLambda$Impl(this.handle);

  void getDeviceId__resultLambda(String p0) {
    final _getDeviceId__resultLambdaFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_core_engine_SDKNativeEngine_GetDeviceIdResultlambda_call__String'));
    final _p0Handle = stringToFfi(p0);
    final _handle = this.handle;
    _getDeviceId__resultLambdaFfi(_handle, __lib.LibraryContext.isolateId, _p0Handle);
...
int _sdkCoreEngineSdknativeengineGetdeviceidresultlambdagetDeviceId__resultLambdaStatic(Object _obj, Pointer<Void> p0) {
  
  try {
    (_obj as SDKNativeEnginegetDeviceId__resultLambda)(stringFromFfi(p0));
  } finally {
...
Pointer<Void> sdkCoreEngineSdknativeengineGetdeviceidresultlambdaToFfi(SDKNativeEnginegetDeviceId__resultLambda value) =>
  _sdkCoreEngineSdknativeengineGetdeviceidresultlambdaCreateProxy(
    __lib.getObjectToken(value),
    __lib.LibraryContext.isolateId,
    value,
    Pointer.fromFunction<Int64 Function(Handle, Pointer<Void>)>(_sdkCoreEngineSdknativeengineGetdeviceidresultlambdagetDeviceId__resultLambdaStatic, __lib.unknownError)
  );


void sdkCoreEngineSdknativeengineGetdeviceidresultlambdaReleaseFfiHandle(Pointer<Void> handle) =>
  _sdkCoreEngineSdknativeengineGetdeviceidresultlambdaReleaseHandle(handle);


// End of SDKNativeEnginegetDeviceId__resultLambda "private" section.
