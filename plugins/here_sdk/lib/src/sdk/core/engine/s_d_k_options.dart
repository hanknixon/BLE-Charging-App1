...
class SDKOptions {
  ...
  @Deprecated("Will be removed in v4.23.0. Please use constructor with AuthenticationMode")
  String accessKeyId;
  ...
  /// It is recommended that the application should have exclusive access to this path, so using shared directories such as `Documents` should be avoided.
  ...
  /// When set to `true` configures internal memory caches to consume less memory.
  /// Reduction in cache sizes also reduces performance.
  bool lowMemoryMode;
  ...
  SDKOptions._(this.accessKeyId, this.accessKeySecret, this.scope, this.cachePath, this.cacheSizeInBytes, this.dataPath, this.persistentMapStoragePath, this.politicalView, this.offlineMode, this.layerConfiguration, this.catalogConfigurations, this.autoUpdateOfOnlineCache, this.customEngineOptions, this.actionOnCacheLock, this.authenticationMode, this.networkSettings, this.lowMemoryMode, this.billingTag);
  ...
  bool operator ==(Object other) {
    ...
    return accessKeyId == _other.accessKeyId &&
        ...
        lowMemoryMode == _other.lowMemoryMode &&
...
final _sdkCoreEngineSdkoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Int64, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Uint32, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>)
...
final _sdkCoreEngineSdkoptionsGetFielddataPath = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKOptions_get_field_dataPath'));
...
final _sdkCoreEngineSdkoptionsGetFieldlowMemoryMode = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKOptions_get_field_lowMemoryMode'));
...
Pointer<Void> sdkCoreEngineSdkoptionsToFfi(SDKOptions value) {
  ...
  final _dataPathHandle = stringToFfi(value.dataPath);
  ...
  booleanReleaseFfiHandle(_lowMemoryModeHandle);
...
SDKOptions sdkCoreEngineSdkoptionsFromFfi(Pointer<Void> handle) {
  ...
  final _dataPathHandle = _sdkCoreEngineSdkoptionsGetFielddataPath(handle);
  ...
  final _lowMemoryModeHandle = _sdkCoreEngineSdkoptionsGetFieldlowMemoryMode(handle);
  ...
  try {
    return SDKOptions._(
      ...
      booleanFromFfi(_lowMemoryModeHandle), 
