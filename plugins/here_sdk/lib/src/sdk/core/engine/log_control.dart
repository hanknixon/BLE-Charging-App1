...
abstract class LogControl implements Finalizable {
...
class LogControl$Impl extends __lib.NativeBase implements LogControl {
  ...
  void setCustomAppender(LogLevel level, LogAppender appender) {
    final _setCustomAppenderFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Int32, Uint32, Pointer<Void>), void Function(int, int, Pointer<Void>)>('here_sdk_sdk_core_engine_LogControl_setAppender__LogLevel_LogAppender'));
    final _levelHandle = sdkCoreEngineLoglevelToFfi(level);
    final _appenderHandle = sdkCoreEngineLogappenderToFfi(appender);
    _setCustomAppenderFfi(__lib.LibraryContext.isolateId, _levelHandle, _appenderHandle);
    sdkCoreEngineLoglevelReleaseFfiHandle(_levelHandle);
