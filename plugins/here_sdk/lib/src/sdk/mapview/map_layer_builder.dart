...
abstract class MapLayerBuilder implements Finalizable {
  ...
  ///
  /// This mapping is used by the layer to request data
  ...
  /// use a storage level that is one level lower than the zoom level, corresponding to an offset of -1.
  ///
