...
abstract class Style implements Finalizable {
...
class Style$Impl extends __lib.NativeBase implements Style {
  ...
  @override
  void update(Style style) {
    final _updateFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_Style_update__Style'));
    final _styleHandle = sdkMapviewStyleToFfi(style);
    final _handle = this.handle;
    _updateFfi(_handle, __lib.LibraryContext.isolateId, _styleHandle);
