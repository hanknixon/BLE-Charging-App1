...
class MapFeatures {
  ...
  /// [MapScheme.roadNetworkNight] and all hybrid schemes: [MapScheme.hybridDay]
  /// [MapScheme.hybridNight], [MapScheme.liteHybridDay]
  /// [MapScheme.liteHybridNight], [MapScheme.logisticsHybridDay] and
  /// [MapScheme.logisticsHybridNight].
  ...
  ///
  /// Supports only one mode: [MapFeatureModes.ambientOcclusionAll].
  ///
