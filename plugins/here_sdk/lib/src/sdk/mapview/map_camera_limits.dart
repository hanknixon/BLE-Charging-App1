...
abstract class MapCameraLimits implements Finalizable {
  ...
  /// When no bearing range is specified for [MapCameraLimits.minZoomLevel], the bearing range set through
  /// [MapCameraLimits.bearingRange] is used for interpolation.
  ///
  ...
  /// Clears bearing ranges for all zoom values and resets [MapCameraLimits.bearingRange]
  /// to default.
  ///
  ...
  ///
  /// The supported values fall inside [MapCameraLimits.minTilt]-[MapCameraLimits.maxTilt] range.
  ...
  /// maximum, depending on which is closest.
  ...
  ///
  /// The supported values fall inside [MapCameraLimits.minZoomLevel]-[MapCameraLimits.maxZoomLevel] range.
