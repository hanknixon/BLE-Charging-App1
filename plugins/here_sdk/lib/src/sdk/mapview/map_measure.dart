...
enum MapMeasureKind {
    ...
    @Deprecated("Will be removed in v4.23.0. Use [MapMeasureKind.distanceInMeters] instead.")
    distance,
    /// The measure kind distance, in meters.
    distanceInMeters,
...
int sdkMapviewMapmeasureKindToFfi(MapMeasureKind value) {
  ...
  case MapMeasureKind.distance:
    return 0;
  case MapMeasureKind.distanceInMeters:
    return 1;
...
MapMeasureKind sdkMapviewMapmeasureKindFromFfi(int handle) {
  ...
  case 1:
    return MapMeasureKind.distanceInMeters;
  case 2:
