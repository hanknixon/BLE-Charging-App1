...
abstract class HereMapControllerCore implements Finalizable {
  ...
  /// when map features are enabled or disbaled using [MapScene.enableFeatures] and [MapScene.disableFeatures].
  ///
...
class HereMapControllerCore$Impl extends __lib.NativeBase implements HereMapControllerCore {
  ...
  @override
  Style get style {
    final _getFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32), Pointer<Void> Function(Pointer<Void>, int)>('here_sdk_sdk_mapview_HereMap_style_get'));
    final _handle = this.handle;
