...
enum MapScheme {
    ...
    hybridNight,
    /// The day version of lite scheme is a simplified version of the [MapScheme.normalDay],
    /// featuring fewer map elements and a more limited color palette.
    liteDay,
    /// The night version of lite scheme is a simplified version of the [MapScheme.normalNight],
    /// featuring fewer map elements and a more limited color palette.
    liteNight,
    /// The day version of lite hybrid scheme is a simplified version of the [MapScheme.hybridDay],
    /// featuring fewer map elements and a more limited color palette.
    liteHybridDay,
    /// The night version of lite hybrid scheme is a simplified version of the [MapScheme.hybridNight],
    /// featuring fewer map elements and a more limited color palette.
    liteHybridNight,
    /// The day version of the logistics map scheme catering to the needs of dispatchers,
    /// fleet managers and delivery drivers, highlighting and featuring map elements relevant to logistics use cases.
    logisticsDay,
    /// The night version of the logistics map scheme catering to the needs of dispatchers,
    /// fleet managers and delivery drivers, highlighting and featuring map elements relevant to logistics use cases.
    logisticsNight,
    /// The day version of the logistics hybrid map scheme catering to the needs of dispatchers,
    /// fleet managers and delivery drivers, highlighting and featuring map elements relevant to logistics use cases.
    logisticsHybridDay,
    /// The night version of the logistics hybrid map scheme catering to the needs of dispatchers,
    /// fleet managers and delivery drivers, highlighting and featuring map elements relevant to logistics use cases.
    logisticsHybridNight,
    /// The day version of a scheme highlighting roads without showing other content such as labels
    ...
    roadNetworkDay,
    /// The night version of a scheme highlighting roads without showing other content such as labels
    /// or buildings. It is designed for usage as an additional zoomed-in mini-maps display to help
    /// drivers to orientate during navigation and to focus on the maneuver arrows which can be
    /// highlighted on top of this map scheme.
    roadNetworkNight
