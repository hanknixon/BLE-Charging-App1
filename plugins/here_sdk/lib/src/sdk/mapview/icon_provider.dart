...
///
/// [iconDescription] An English description of the created icon. For example, "Federal Highway"
///                   for the road shield icon with the [RouteType.level1Road] in Brazil.
    ...
    _iconProviderInternal?.createRoadShieldIcon(
      ...
      if (icon != null && !icon.isEmpty) {
        ...
        try {
          ...
          SDKLogger.error('createRoadShieldIcon', 'Error when creating image from road-shield icon-data $e');
        }
