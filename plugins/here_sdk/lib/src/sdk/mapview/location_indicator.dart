...
abstract class LocationIndicator implements Finalizable {
  ...
  /// [LocationIndicator.updateLocationAndCamera] is visualized by scaling the accuracy indicator halo accordingly.
  ...
  /// the halo has a fixed and zoom level independent size.
  ///
  /// When set to `true`, the radius of the halo corresponds to the value of
  ...
  ///
  /// If the location indicator is set to inactive (which can be checked via [LocationIndicator.isActive] flag),
  ...
  ///   - If the accuracy visualization is set to `true`, the size of the halo scales with
  ///     [Location.horizontalAccuracyInMeters] in world coordinates.
  ///   - If the accuracy visualization is set to `false`, halo displays at a default size.
  /// - Custom location indicator:
  ///   - If the accuracy visualization is set to `true`, halo is shown and the size of the halo scales with
  ///     [Location.horizontalAccuracyInMeters] in world coordinates.
  ...
  /// By default, it is set to [LocationIndicatorIndicatorStyle.pedestrian].
...
class LocationIndicator$Impl extends __lib.NativeBase implements LocationIndicator {
  ...
  @override
  void setHaloColor(LocationIndicatorIndicatorStyle style, ui.Color color) {
    final _setHaloColorFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Uint32, Pointer<Void>), void Function(Pointer<Void>, int, int, Pointer<Void>)>('here_sdk_sdk_mapview_LocationIndicator_setHaloColor__IndicatorStyle_Color'));
    final _styleHandle = sdkMapviewLocationindicatorIndicatorstyleToFfi(style);
    final _colorHandle = sdkCoreColorToFfi(color);
    final _handle = this.handle;
    _setHaloColorFfi(_handle, __lib.LibraryContext.isolateId, _styleHandle, _colorHandle);
    sdkMapviewLocationindicatorIndicatorstyleReleaseFfiHandle(_styleHandle);
  ...
  @override
  ui.Color getHaloColor(LocationIndicatorIndicatorStyle style) {
    final _getHaloColorFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32, Uint32), Pointer<Void> Function(Pointer<Void>, int, int)>('here_sdk_sdk_mapview_LocationIndicator_getHaloColor__IndicatorStyle'));
    final _styleHandle = sdkMapviewLocationindicatorIndicatorstyleToFfi(style);
    final _handle = this.handle;
    final __resultHandle = _getHaloColorFfi(_handle, __lib.LibraryContext.isolateId, _styleHandle);
    sdkMapviewLocationindicatorIndicatorstyleReleaseFfiHandle(_styleHandle);
    try {
