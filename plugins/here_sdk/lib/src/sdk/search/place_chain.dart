...
class PlaceChain {
  ...
  /// The complete list of supported chain IDs can be found [here](https://www.here.com/docs/bundle/geocoding-and-search-api-developer-guide/page/topics-places/places-chain-system-full.html).
  String id;
