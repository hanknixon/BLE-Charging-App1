...
abstract class Suggestion implements Finalizable {
  ...
  /// The suggested place.
  /// Note: Available only for [SuggestionType.place].
  /// Gets the suggested place item.
  Place? get place;

  /// The unique id of suggested item. It can be used to query further information.
  /// Note: For online search, suggestion of type [SuggestionType.place]
  /// will have Suggestion.id same as Place.id.
  /// Note: For offline search, only suggestion of type [SuggestionType.chain],
  ...
  /// Note: Available only for [SuggestionType.chain] and [SuggestionType.category].
  /// Gets the direct link for Discover query.
  /// Note: This is not supported in offline search.
  String? get href;
