...
class POIPaymentDetails {
  ...
  POIPaymentDetails()
    : acceptedMethods = [], acceptedCashCurrencies = null;
  @override
...
Pointer<Void> sdkSearchPoipaymentdetailsToFfi(POIPaymentDetails value) {
  ...
  final _acceptedCashCurrenciesHandle = heresdkSearchCommonBindingslistofStringToFfiNullable(value.acceptedCashCurrencies);
  ...
  heresdkSearchCommonBindingslistofStringReleaseFfiHandleNullable(_acceptedCashCurrenciesHandle);
  return _result;
}
...
POIPaymentDetails sdkSearchPoipaymentdetailsFromFfi(Pointer<Void> handle) {
  ...
  try {
    return POIPaymentDetails._(
      ...
      heresdkSearchCommonBindingslistofStringFromFfiNullable(_acceptedCashCurrenciesHandle)
    );
  } finally {
    heresdkSearchCommonBindingslistofStringReleaseFfiHandle(_acceptedMethodsHandle);
    heresdkSearchCommonBindingslistofStringReleaseFfiHandleNullable(_acceptedCashCurrenciesHandle);
