                  ...
                  Center(
                    child: OutlinedButton(
                        style: OutlinedButton.styleFrom(
                          fixedSize: Size(
                              MCUI.adjustedWidthWithCotext(MCConstants.ctaBtnWidth, context),
                        ...
                        onPressed: () {
                          NavigatorMain.navStack
                              .push(NavStackRecord(this, context));
                          Future.delayed(const Duration(
                                  milliseconds: MCUI.backBtnDisplayDelayMilSec))
                              .then((val) {
                            backBtnVisible.value =
                                NavigatorMain.navStack.isNotEmpty;
                          });
                          Navigator.of(context).push(
                            MCUI.getSlideAnimationRouteBuilder(ScannerV()),
                          );
